...
use FeedbackBundle\Entity\CommentStatus;
use FeedbackBundle\Form\CommentStatusType;
...
class CommentStatusController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FeedbackBundle\Form\CommentStatusType', $commentStatus);
    ...
    {
        $editForm = $this->createForm('FeedbackBundle\Form\CommentStatusType', $commentStatus);
