...
class PersonController extends AbstractController implements PaginatorAwareInterface {
     ...
     * Finds and displays a Person entity.
     *
     * @Route("/json/{id}", name="person_ld", defaults={}, methods={"GET"})
     *
     * @return array
     */
    /**public function JsonLd(Request $request, Person $person) {

        $title = $person->getTitle(true);
        $title->
        return new JsonResponse([
                ...
                '@graph' => [
                    ...
                    'sameAs'=>[
                        $person->getWikipediaUrl(),
                        $person->getViafUrl(),
                    ],
                    'birthDate'=>$person->getDob(),
                    'deathDate'=>$person->getDod(),
                    'birthPlace'=>$person->getCityOfBirth()->getName(),
                    'deathPlace'=>$person->getCityOfDeath()->getName(),
                    '@id'=>"localhost/person/".$person->getId(),
                    ],
                   [
                      "@type"=> "Book",
                      "@id"=>"localhost/title/". $title->get,
                      "name"=> "",
                      "Genre"=>"",
                      "datePublished"=>"",
                      "locationCreated"=> [
                      ...
                      "author"=> [{
                        ...
                        {
                            "@id":"https://womensprinthistoryproject.com/person/495"
                        },
                        {
                            "@id": "https://womensprinthistoryproject.com/person/515"
                        }
                      ],
                      "publisher": [{
                            "@type":"Organization",
                          "name":"Edward Lacey",
                          "@id":"https://womensprinthistoryproject.com/firm/950",
                          "address": "76 St. Paul's Churchyard, London"
                      },
                        {
                            "@type":"Organization",
                          "name":"Sears and Trapp, Printers",
                          "@id":"https://womensprinthistoryproject.com/firm/1452",
                          "address": "11 Budge Row, London"
                        }
                      ]
                   ]
                ]
