...
#[Route(path: '/resource/orlando_biblio')]
class OrlandoBiblioController extends AbstractController implements PaginatorAwareInterface {
     ...
     */
    #[Route(path: '/', name: 'resource_orlando_biblio_index', methods: ['GET'])]
    #[Template]
     ...
     *
     * @return array<string,mixed> * @Route("/search", name="resource_orlando_biblio_search", methods={"GET"})
     */
    #[Template]
     ...
     * @return array<string,mixed> *
     */
    #[Route(path: '/{id}', name: 'resource_orlando_biblio_show', methods: ['GET'])]
    #[Template]
