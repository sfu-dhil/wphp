...
//        $repo->method('findAll')->willReturn(array('a', 'b'));
//        $this->importer->setTitleRepo($repo);
//
//        $importer = $this->getContainer()->get(EstcMarcImporter::class);
//        $this->assertEquals(2, $importer->checkTitle('fooo'));
//        $this->assertCount(1, $importer->getMessages());
//    }
//
//    /**
